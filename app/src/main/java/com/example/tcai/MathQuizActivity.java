...
public class MathQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent it = new Intent(MathQuizActivity.this, DecisionActivity.class);
                startActivity(it);
                finish();
            }
        });
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(answer.equals(qanda.answers[questionnumber])) {
                sc++;
                }
                questionnumber++;
                newquestions();
    ...
    void newquestions(){
        if(questionnumber == total){
            ...
            quest.setText(qanda.questions[questionnumber]);
            answ.setText("");
...
//        String Faculty1 = sp.getString("Faculty","");
        ...
        new AlertDialog.Builder(this).setTitle("Score").setMessage("Your score is: "+ sc).setPositiveButton("Save", (dialogInterface, i) -> writeToFile(Name1+sc+".txt",sc)).setCancelable(true).show();
    }
    void exit(){
        sc = 0;
        questionnumber = 0;
...
//        fname = name+".txt";
//        fpath = "MathQuiz";
//        fcontent = String.valueOf(score);
//        if(!ExternalStorageAvailableForRW()){
//            File extfile = new File(getExternalFilesDir(fpath), fname);
//            FileOutputStream fileos = null;
//            try {
//                fileos = new FileOutputStream(extfile);
//                fileos.write(fcontent.getBytes());
//                fileos.close();
...
//                throw new RuntimeException(e);
//            }
//            Toast.makeText(this, "Saved" + score, Toast.LENGTH_SHORT).show();
//        }
//
//    }
...
//        if(exst.equals(Environment.MEDIA_MOUNTED)){
//            return true;
//        }
//        return false;
//    }
    ...
    private void writeToFile(String name, int score){
        ...
        try{
//        File root = new File(Environment.getExternalStorageDirectory(), "TestMath");
//        if(!root.exists()){
//            root.mkdir();
//        }
